...
import com.sdot.yidai.ui.SjshActivity;
...
public class SjshDanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sjsh_dan);
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (errorCode.equals("0")) {
                                ...
                                productStateVo = null;
                                ToastUtils.getInstance(SjshDanActivity.this).showMessage("网络异常请稍后再试");
                            }
    ...
    private void requestSjsh(){
        if(productStateVo==null){
            ...
            startActivity(new Intent(this, ApplyDateListActivity.class));
        }else if((wdxydVo.getState()!=null&&(wdxydVo.getState().equals("CREATED")||wdxydVo.getState().equals("DENIED")))
                ||
             ...
             ToastUtils.getInstance(this).showMessage("您有其他产品正在审核中");
                ...
                startActivity(new Intent(this,SjshActivity.class).putExtra("product",sort));
                this.finish();
                }
