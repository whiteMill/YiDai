...
public class ApplyRongZActivity extends BaseActivity {
    ...
    private String city;
    private String area;
    private String defult_tiem = "24";
    private static final String TAG = "ApplyRongZActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_rong_z);
    ...
    private void initAlterDialog() {
        ...
        builder.setItems(getResources().getStringArray(R.array.rongzi_time), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                switch (i) {
                    case 0:
                        qixianEdittext.setText("24期");
                        defult_tiem = "24";
                        break;
                    case 1:
                        qixianEdittext.setText("36期");
                        defult_tiem = "36";
                        break;
                }
    ...
    private void requestRzzl() {
                  if(isIc){
                      ...
                      } else if (dailiEdittext.getText().toString().isEmpty()) {
    ...
    @OnClick({R.id.back, R.id.apply_money, R.id.dali_layout, R.id.qixian_layout, R.id.dailiqu_layout, R.id.user_permission})
    ...
    private void applyRongZi() {
        Map<String, String> params = new HashMap<>();
        params.put("product", "/rest/products/3");
      ...
      //  params.put("serviceName", dailiEdittext.getText().toString());
        ...
        OkGo.<String>post(URL.APPLY_RONGZZL).tag(this)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(response.body()==""){
                            ToastUtils.getInstance(ApplyRongZActivity.this).showMessage("申请成功");
                            startActivity(new Intent(ApplyRongZActivity.this, RongZiSuccessActivity.class));
                            ApplyRongZActivity.this.finish();
                        }else{
                            ...
                            try {
                                ...
                                switch (jsonObject.getString("ErrorCode")){
                                    case "6657" :
                                        ToastUtils.getInstance(ApplyRongZActivity.this).showMessage(jsonObject.getString("ErrorInfo"));
                                        break;
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                                ToastUtils.getInstance(ApplyRongZActivity.this).showMessage("申请失败");
                            }
                        }
                    }
