...
public class RongZiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rong_zi);
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (errorCode.equals("0")) {
                                ...
                                productStateVo = null;
                                ToastUtils.getInstance(RongZiActivity.this).showMessage("网络异常请稍后再试");
                            }
    ...
    private void requestSjsh(){
        if (productStateVo == null) {
            ...
            startActivity(new Intent(this,ApplyRongZActivity.class).putExtra("product",sort));
            this.finish();
        }
    }
}
