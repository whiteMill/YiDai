...
public class EduProgressView extends View {
    ...
    public EduProgressView(Context context) {
        super(context);
    }

    public EduProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        // 获取自定义的属性
    ...
    public EduProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initVariable() {
        ...
        mUsePaint.setColor(getResources().getColor(R.color.black));
        mUsePaint.setTextSize(ScreenUtil.sp2px(mContext, 12));

        //圆环画笔设置
        mRingDefaultPaint = new Paint();
        mRingDefaultPaint.setAntiAlias(true);
        mRingDefaultPaint.setColor(getResources().getColor(R.color.deep_gray));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(sup, perX, mYCenter- mTxtHeight, mUsePaint);
    }
